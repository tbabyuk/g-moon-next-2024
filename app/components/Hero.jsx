        ...
        <div className="min-h-[calc(100vh-115px)] bg-[url('/hero-bg.jpg')] bg-center bg-cover grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="flex flex-col items-center lg:items-start text-g-moon-white px-6 md:px-12 py-12 md:py-20">
                ...
                <ul className="text-xl space-y-4 mb-12">
                    <li className="flex items-center"><IoMdCheckmarkCircle className="text-white me-2" />Rejuvenating Massages</li>
                    <li className="flex items-center"><IoMdCheckmarkCircle className="text-white me-2" />Experienced Staff</li>
                    <li className="flex items-center"><IoMdCheckmarkCircle className="text-white me-2" />Quick Online Booking</li>
                </ul>

...
export const TopHeader = () => {
    ...
    return (
        <>
            ...
            {popupIsOpen && 
                <div className="popup-banner min-h-[80px] px-5 py-5 w-[100%] bg-[url('/banner-bg.jpg')] bg-center absolute z-40 top-0 flex justify-center items-center">
                    <IoMdClose className="absolute top-2 right-2 text-[3rem] text-white cursor-pointer" onClick={() => setPopupIsOpen(false)} />

    ...
    return (
        <div className="bg-[url('/images/header-bg.jpg')] bg-center bg-cover text-g-moon-light-gray p-6 text-[0.9rem] min-h-[40px] md:max-h-[60px] flex flex-col items-center md:flex-row md:justify-between">
            <div className="flex flex-col md:flex-row">
                <div className="mb-6 md:mb-0 flex items-center justify-center md:justify-center md:me-14"><a href="mailto:vivi@g-moon-wellness.ca" className="flex items-center g-moon-link"><AiOutlineMail className="me-4 text-[22px] shrink-0" />g.moon.wellness@gmail.com</a></div>

            ...
            <div className="flex-1 pt-16 md:pt-0 md:flex md:flex-col md:items-center">
                <div>
                    ...
                    <ul className="flex flex-col justify-center space-y-6 text-[0.85rem]">
                        ...
                        <li className="w-fit"><a href="mailto:vivi@g-moon-wellness.ca" className="flex items-center g-moon-link"><AiOutlineMail className="me-2 text-[18px]" />g.moon.wellness@gmail.com</a></li>

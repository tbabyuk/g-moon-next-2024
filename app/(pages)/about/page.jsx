...
const AboutPage = () => {
    ...
    return(
        <main>
            ...
            <p className="g-moon-content-padding">G Moon Wellness is located in Richmond Hill nearby highway 7. Our spa area is near popular restaurants in Ontario. Our spa has been running for more than 3 years.<br /><br />

...
export const metadata = {
    title: "Shiatsu Massage | G Moon Wellness Centre",
    ...
    return(
        <main className="text-g-moon-dark-gray">
            ...
            <div className="g-moon-content-padding">
                ...
                <p className="g-moon-mb">Shiatsu focuses on balancing the body&apos;s vital energy (Qi) by applying pressure to key points along the meridians. This technique helps to clear blockages, enhance energy flow, and support your body&apos;s natural healing abilities.</p>
                <PageSubSubheader title="Holistic Touch" />
                <p className="g-moon-mb">Our skilled therapists use their fingers, palms, and thumbs to apply rhythmic pressure, stretching, and gentle manipulation. This approach works to release muscle tension, improve flexibility, and promote relaxation.</p>
                <PageSubSubheader title="Stress Reduction" />
                <p className="g-moon-mb">The methodical pressure and stretches help to reduce stress and anxiety, fostering a deep sense of calm and tranquility. Shiatsu can also improve mood and enhance overall emotional well-being.</p>
                <PageSubSubheader title="Improved Circulation" />
                <p className="g-moon-mb">By stimulating the meridians, Shiatsu enhances blood flow and oxygen delivery to tissues, aiding in detoxification and boosting energy levels.</p>
                <PageSubSubheader title="Muscle and Joint Relief" />
                <p className="g-moon-mb">This therapeutic technique is effective in addressing muscular discomfort and joint stiffness, making it an excellent choice for those seeking relief from physical tension and pain.</p>
